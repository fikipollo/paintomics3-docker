...
SERVER_PORT_NUMBER        = 80 ##THE PORT NUMBER THAT GALAKSIO LISTENS FOR REQUESTS
...
#FILES SETTINGS
ROOT_DIRECTORY            = "/usr/local/apache2/htdocs/PaintomicsServer/src/" ##THE LOCATION FOR THE GALAKSIO FILES, LEAVE BLANK TO AUTO DETECT
EXAMPLE_FILES_DIR         = ROOT_DIRECTORY + "/examplefiles/"
CLIENT_TMP_DIR            = "/data/paintomics3/CLIENT_TMP/"
KEGG_DATA_DIR             = "/data/paintomics3/KEGG_DATA/"
MAX_CLIENT_SPACE          = 20 * pow(1024,2) #MAX_CLIENT_SPACE IN MB

#MONGO DB SETTINGS
MONGODB_HOST      = "paintomics3-mongo"
MONGODB_PORT      = 27017
MONGODB_DATABASE  = "PaintomicsDB"

#MULTI-THREADING OPTIONS
MAX_THREADS      = 6
MAX_WAIT_THREADS = 600 #IN SECONDS
N_WORKERS        = 4
